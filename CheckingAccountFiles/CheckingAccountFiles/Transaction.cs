...
namespace CheckingAccountClasses
{
    public class Transaction
    {
        ...
        public Transaction(decimal transAmount, string transType, DateTime transDate, string _payee)
        {
            if (transType == "Withdrawal" && _payee == "")
                throw new ApplicationException("Withdrawal must have payee");
            TransactionAmount = transAmount;
            TransactionType = transType;
            TransactionDate = transDate;
            Payee = _payee;
        ...
        public decimal TransactionAmount
        {
            ...
            set
            {
                if (IsPositive(value))
                    ...
                    throw new ApplicationException("Transaction amount must be a decimal greater than 0");
            }
